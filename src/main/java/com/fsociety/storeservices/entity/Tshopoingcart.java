...
@NamedQueries({
        ...
        @NamedQuery(name = "Tshopoingcart.findShopoingcartByOrderAndProduct",
                query = "SELECT s FROM Tshopoingcart s where s.idOrder.id = :idOrder and s.idProduct.id = :idProduct and s.status=true")
})
